 ...
 *
 * @TODO: remove this and depend instead on com.capgemini:springboot-camel-metrics-publisher, AND SPRING-IMPORT IT EXPLICITLY IN Application.java?
 */
@Configuration
    ...
    protected ServletContextListener listener() {
        return new ServletContextListener() {
            ...
            public void contextInitialized(ServletContextEvent sce) {
                ...
                LOGGER.info("ServletContext initialized (including setting CodaHale MetricsRegistry");
            }
...
//     *
//     * TODO: check this isn't happening twice
//     */
//    @Bean
...
//    }
    ...
    public ServletRegistrationBean codahaleMetricsServletRegistrationBean() {
        ...
        ServletRegistrationBean servletRegistrationBean = new ServletRegistrationBean(metricsServlet);
        servletRegistrationBean.addUrlMappings(monitoringServletsPath + "/codahale.metrics");
    ...
    public ServletRegistrationBean threadDumpServletRegistrationBean() {
        ...
        ServletRegistrationBean servletRegistrationBean = new ServletRegistrationBean(threadDumpServlet);
        servletRegistrationBean.addUrlMappings(monitoringServletsPath + "/threads");
